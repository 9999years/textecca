...
macro_rules! arg {
    (var $name:expr) => {
        $crate::eval::arg_spec::Arg::VarArgs(String::from($name))
    };
    (kw $name:expr) => {
        $crate::eval::arg_spec::Arg::KwArgs(String::from($name))
    };
    (opt pos $name:expr) => {
        $crate::eval::arg_spec::Arg::Normal(
            $crate::eval::arg_spec::NormalArg::new_optional_positional(String::from($name)),
        )
    };
    (opt $name:expr) => {
        $crate::eval::arg_spec::Arg::Normal($crate::eval::arg_spec::NormalArg::new_optional(
            String::from($name),
        ))
    };
    (opt kw $name:expr) => {
        $crate::eval::arg_spec::Arg::Normal(
            $crate::eval::arg_spec::NormalArg::new_optional_keyword(String::from($name)),
        )
    };
    (pos $name:expr) => {
        $crate::eval::arg_spec::Arg::Normal($crate::eval::arg_spec::NormalArg::new_positional_only(
            String::from($name),
        ))
    };
    ($name:expr) => {
        $crate::eval::arg_spec::Arg::Normal($crate::eval::arg_spec::NormalArg::new_positional(
            String::from($name),
        ))
    };
}
